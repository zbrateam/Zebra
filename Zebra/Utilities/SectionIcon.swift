...
struct SectionIcon {
	...
	private static let sections: [String: SectionIcon] = [
		...
		"Dictionaries":       SectionIcon(image: .systemNamedImage("character.book.closed.fill", "a.book.closed.fill"), gradient: .teal),
		...
		"Java":               SectionIcon(image: .systemNamedImage("cup.and.saucer.fill", "j.square.fill"), gradient: .blue),
		...
		"Libraries":          SectionIcon(image: .systemNamedImage("command"), gradient: .orange),
		"libs":               SectionIcon(image: .systemNamedImage("command"), gradient: .orange),
		"Localizations":      SectionIcon(image: .systemNamedImage("globe.asia.australia.fill", "globe"), gradient: .green),
		...
		"Networking":         SectionIcon(image: .systemNamedImage("wifi"), gradient: .green),
