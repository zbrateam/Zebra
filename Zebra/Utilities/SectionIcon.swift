...
struct SectionIcon {
	...
	private static let sections: [String: SectionIcon] = [
		...
		"Localizations":      SectionIcon(image: .systemNamedImage("globe.asia.australia.fill"), gradient: .green),
		...
		"Networking":         SectionIcon(image: .systemNamedImage("antenna.radiowaves.left.and.right"), gradient: .green),
