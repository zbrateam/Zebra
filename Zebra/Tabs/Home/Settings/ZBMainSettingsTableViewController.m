...
- (void)timeoutToggle {
    ...
    [controller setFooterText:@[@"Configure the amount of time Zebra will wait for a source to respond before timing out.", @"This timer will reset every time that Zebra receives new information from a source."]];
